...
	eggnog_db: path to the [eggNOG](https://github.com/eggnogdb/eggnog-mapper/wiki/eggNOG-mapper-v2.1.5-to-v2.1.12#user-content-Installation) database directory
	bakta_db: path to the [Bakta](https://ecogenomics.github.io/GTDBTk/installing/index.html) database directory
...
quality filtered [Filtlong](https://github.com/rrwick/Filtlong).
